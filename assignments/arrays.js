...
console.log("The make and model of the last car in the inventory is a " + inventory[lastCar].car_make + " " + inventory[lastCar].car_model);
...
let BMWAndAudi = [];
for (let i=0; i<inventory.length; i++){
  let aAndB = inventory[i];
  if (aAndB.car_make === "Audi" || aAndB.car_make === "BMW") {
    BMWAndAudi.push(aAndB);
  }
}
